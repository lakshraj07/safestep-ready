...
# Design baseline: clinical UI — warm paper surfaces, warm ink, red-orange brand
...
<title>SafeStep — Report — {pt['name']}</title><style>{CSS}</style></head>
<body class="{'embed' if embed else ''}">
<div class="wrap">
<header>
  <h1>SafeStep<span class="dot">.</span> Home-Readiness Report</h1>
...
<p class="meta">SafeStep read the SNF note + after-visit summary (Medplum artifacts)
...
<div class="footer"><b>Medplum holds the chart. SafeStep verifies the home and writes back.</b><br>
...
clinician review required — drafts only</div>
</div></body></html>"""
