"""Obligations engine: Medplum note in → what must be true at home → score vs scan.

Derives post-encounter obligations from the discharge note, then scores each
against walkthrough evidence (findings, measurements, caregiver answers).
"""
