...
Medplum holds the chart. SafeStep carries the plan forward: it identifies what must happen next, discovers what may prevent it, advances the required actions, confirms completion, and escalates unresolved barriers to the right person.
...
Monica’s niece walks the apartment with an iPhone. Relay combines:
...
- Medplum transcript, note, and after-visit plan.
...
| **Data availability** | Good but fragmented across Medplum, the EHR, payer systems, suppliers, patients, and caregivers. |
...
For Monica, a 76-year-old leaving skilled nursing rehabilitation, Relay becomes a home-readiness agent. Her caregiver walks the apartment with an iPhone. Relay combines her chart, a guided conversation, camera evidence, and LiDAR measurements to identify hazards and test whether the discharge plan is physically possible.
...
> **Medplum holds the chart. SafeStep carries the plan into the home.**
