...
// MARK: - Design tokens (baseline: clinical UI — warm paper, warm ink, red-orange)
    ...
    var body: some View {
        VStack(spacing: 0) {
            HStack(spacing: 10) {
                ...
                Text("SafeStep").font(.headline.bold())
                Text("·").opacity(0.6)
...
// MARK: - Note markdown (faithful to the Medplum note)
        ...
        case .bullet(let text):
            if isHighlighted(text) {
                VStack(alignment: .leading, spacing: 5) {
                    ...
                    Label("Why SafeStep was engaged — this can't be verified from the chart",
...
struct ClinicianPortalView: View {
    ...
    private var sidebar: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            Spacer()
            Text("Ambient notes from Medplum\nHome verification by SafeStep")
                .font(.caption2)
    ...
    private var processingCard: some View {
        HStack(spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 3) {
                Text("SafeStep · walk-through in progress")
                    .font(.headline)
    ...
    private var statusCard: some View {
        ...
        let title: String = cleared
            ? "SafeStep — VERIFIED, cleared for discharge"
            : (blocked > 0 ? "SafeStep — discharge plan BLOCKED by the home"
                           : "SafeStep — assessment on file")
    ...
    private var planCard: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Text("Monica's clinical team believes she may be ready to go home. "
                 + "SafeStep answers the question her chart cannot: "
            ...
            Button {
                ...
                Label(handedOff ? "SafeStep accepted — notifying Monica…"
                                : "Hand over to SafeStep",
    ...
    private var header: some View {
        HStack(spacing: 14) {
            ...
            VStack(alignment: .leading, spacing: 1) {
                ...
                Text("walk-through \(runId ?? "…") · drafted by SafeStep, decided by clinicians")
                    .font(.caption)
    ...
    private var actionRail: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 14) {
                ...
                if !approvals.isEmpty {
                    sectionCaption("Actions drafted by SafeStep")
                }
...
struct DischargedView: View {
    ...
    var body: some View {
        VStack(spacing: 22) {
            ...
            Text("Medplum holds the chart. SafeStep verifies the home and writes back.")
